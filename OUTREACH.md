...
**Contact:** (541) 926-7326 · website contact form at depotrestaurantinc.com/contact-us  
**Best path:** Call first (local family business), then email or leave a short note with the concept link.

### Phone script (30–45 sec)

> Hi, my name is Terin. I’m local and I put together a free redesign concept for The Depot’s website — just a design idea, not affiliated with you. It highlights the 1976 history, fish & chips, and the historic building a bit more clearly on mobile. Would it be okay if I emailed the link so you can look when you have a minute? No pressure either way.

### Email / message body

**Subject:** Free website concept for The Depot (no obligation)
...
## 2. Millie's Vintage Resale

**Contact:** milliesvintagealbany@gmail.com · (541) 981-9461  
**Best path:** Email (they listed it publicly at opening).

### Email body

**Subject:** Free website concept for Millie’s Vintage (design idea only)
...
If you ever want something like this built for real (easy for you to update yourself), I’m happy to chat. If not, feel free to ignore — hope it’s still useful as a reference.
...
## Follow-up (if no reply after 7–10 days)

> Just bumping this in case it got buried. Still no obligation — the concept is there if useful. Happy to take it down or adjust if you’d rather not have it public.

---

## Tracking

| Business | Sent? | Date | Channel | Response |
|----------|-------|------|---------|----------|
